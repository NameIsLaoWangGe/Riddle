...
export module record {
    ...
    export enum Engine {
        ...
        'mask_01' = '作为遮罩的那个sprite或者是img必须有图片，这样才能有大小，才能有显示位置。',

        'mask_02' = 'mask的图片和所属sprite必须不能留有半个像素的颜色，切图需要注意，图片边缘要非常的完整，不要存在半个像素，否则可能导致图片遮罩时不显示，或者边缘遮罩计算错误。',
    ...
    export enum PhysicsAndBox2d {
        ...
        'BoxCollider_01' = '方形碰撞框，目前是以两个物体的第一次碰到的边作为进入碰撞，持续碰撞，结束碰撞来计算的，所以对碰撞框是有要求的，例如父节点的box被挤压后，有穿透，带着子节点位移了，很容易就会结束碰撞',

        'BoxCollider_02' = '速度过快时，刚体碰撞可能报错！'
